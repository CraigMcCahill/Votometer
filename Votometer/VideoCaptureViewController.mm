...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        //for face tracking no need for color
        //_captureGrayscale = YES;
        
        //for measuring red and green we need colors
...
- (void) redirectConsoleLogToDocumentFolder
{
    ...
    NSString *logPath = [documentsDirectory
                         stringByAppendingPathComponent:@"console.txt"];
...
- (BOOL)createCaptureSessionForCamera:(NSInteger)camera qualityPreset:(NSString *)qualityPreset grayscale:(BOOL)grayscale
{
    ...
    //_videoOutput.minFrameDuration = ;
    
    //[_videoOutput setVideoMinFrameDuration:CMTimeMake(1, 30)];
    //_videoOutput.setMin
