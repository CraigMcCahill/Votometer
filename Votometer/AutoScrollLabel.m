...
- (void) readjustLabels
{
	...
	for (int i = 0; i < NUM_LABELS; ++i){
        ...
        //size to fit not working the custom font - add 20 pixels
        CGRect highFrame = label[i].frame;
        highFrame.size.height = highFrame.size.height + 20;
        label[i].frame = highFrame;
